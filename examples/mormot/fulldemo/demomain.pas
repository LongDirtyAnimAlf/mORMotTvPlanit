...
uses
 ...
 {$ENDIF}
  ...
  VpContactButtons, VpmORMotDS, VpNavBar, VpData, VpPrtPrvDlg, VpPrtFmtDlg, Types,
  VpBase, VpCalendar;
...
type
  ...
  private
    ...
    mORMotDatastore: TVpmORMotDatastore;
...
begin
  ...
  mORMotDatastore := TVpmORMotDatastore.Create(self);

  if Assigned(mORMotDatastore) then with mORMotDatastore do
  begin
    ...
    VpControlLink1.DataStore:=mORMotDatastore;
    VpMonthView1.DataStore:=mORMotDatastore;
    VpDayView1.DataStore:=mORMotDatastore;
    VpDayView1.AllowDragAndDrop:=True;
    VpWeekView1.DataStore:=mORMotDatastore;
    VpTaskList1.DataStore:=mORMotDatastore;
    VpContactGrid1.DataStore:=mORMotDatastore;
    VpResourceCombo1.DataStore:=mORMotDatastore;
    VpResourceEditDialog1.DataStore:=mORMotDatastore;
    VpPrintPreviewDialog1.DataStore:=mORMotDatastore;
    VpPrintFormatEditDialog1.DataStore:=mORMotDatastore;
  ...
  begin
    ...
    //lastRes := ds.Resources.Items[0];
    ds.ResourceID := lastRes.ResourceID;
  end;

  // enable timer for remote polling (live update)
  if Assigned(mORMotDatastore) then Timer1.Enabled:=True;
end;
